...
const MOCK_VAULT_FILES = [
    { id: 1, name: 'Q3_Financial_Report.pdf', type: 'pdf', size: '3.2 MB', status: 'indexed' },
    { id: 2, name: 'Board_Meeting_Oct.wav', type: 'audio', size: '14.1 MB', status: 'indexed' },
    { id: 3, name: 'Architecture_Diagram.png', type: 'image', size: '1.8 MB', status: 'indexed' },
    { id: 4, name: 'MSA_Vendor_Agreement.pdf', type: 'pdf', size: '840 KB', status: 'indexed' },
];
...
const INITIAL_MESSAGES = [
    {
        id: 'msg-1',
        role: 'user',
        content: "Cross-reference the Q3 financial risks with yesterday's board meeting audio. Are there any contradictions regarding our liquidity runway?"
    },
    {
        id: 'msg-2',
        role: 'agent',
        status: 'complete',
        reasoning: [
            { step: 'Action: SearchLocalVault', details: 'Query: "Q3 financial risk OR liquidity runway"', time: '0.2s' },
            { step: 'Retrieved: Q3_Financial_Report.pdf', details: 'Chunks: 4 (Pages 12, 14, 15)', time: '0.4s' },
            { step: 'Action: SearchLocalVault', details: 'Query: "board meeting audio liquidity runway contradiction"', time: '0.1s' },
            { step: 'Retrieved: Board_Meeting_Oct.wav', details: 'Transcribed Chunks: 2 (Timestamps 04:12, 45:30)', time: '0.5s' },
            { step: 'Action: CrossReferenceEntities', details: 'Comparing PDF claims vs Audio transcripts...', time: '1.2s' },
            { step: 'Observation: Contradiction found.', details: 'PDF claims 18 months; Audio claims 12 months.', time: '0.1s' }
        ],
        content: "Yes, there is a direct contradiction regarding the liquidity runway between the written report and the verbal board discussion.\n\nAccording to the **Q3 Financial Report**, the company maintains a \"strong liquidity position with an estimated runway of 18 months under current burn rates\" [1].\n\nHowever, during the **Board Meeting Audio**, the CFO explicitly contradicted this, stating: \"Given the delayed receivables from Q2, our actual safe runway is closer to 12 months, and we need to adjust the written Q3 models before public release\" [2].",
        citations: [
            {
                id: 1,
                text: 'Q3_Financial_Report.pdf',
                ref: 'Page 14, Paragraph 2',
                chunk: "Our conservative modeling indicates a strong liquidity position with an estimated runway of 18 months under current burn rates. This assumes no further capital injection and a stable macroeconomic environment."
            },
            {
                id: 2,
                text: 'Board_Meeting_Oct.wav',
                ref: 'Timestamp 04:12 - 04:45',
                chunk: "[04:12] Sarah (CFO): I know the draft report says 18 months, but frankly, given the delayed receivables from Q2, our actual safe runway is closer to 12 months, and we need to adjust the written Q3 models before public release next week."
            }
        ]
    }
];
    ...
    const handleSend = () => {
        ...
        setTimeout(() => {
            setMessages(prev => prev.map(msg => msg.id === thinkingId ? {
                ...
                status: 'complete',
                reasoning: [
                    { step: 'Action: VectorSearch', details: 'Query: "Follow up context analysis"', time: '0.3s' },
                    { step: 'Action: Synthesize', details: 'Formatting final markdown output...', time: '0.8s' }
                ],
                content: "I have updated the analytical model based on your new parameters. The local vault has been re-scanned for relevant edge cases.",
                citations: []
            } : msg));
        }, 4500); // Wait enough time to show the dynamic thinking states
    };
